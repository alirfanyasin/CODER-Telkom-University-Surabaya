                ...
                <div>
                    <div class="grid grid-cols-1 gap-4 mb-3 lg:grid-cols-2">
                        <div class="mb-3">
                            ...
                            <input type="number" wire:model="form.presence_number" disabled name="presence"
                                id="presence" class="w-full px-3 py-3 text-white rounded-lg bg-lightGray">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="date-time" id="date-time"
                                class="w-full px-3 py-3 text-white rounded-lg bg-lightGray" disabled
                                wire:model="form.presence_date">
                        </div>
                    </div>
                    <div class="mb-3">
                                    ...
                                    <div class="overflow-hidden rounded-md">
                                        <table class="min-w-full bg-lightGray">
                                            <thead class="bg-[#43474C]">
                                                <tr>
                                                    <th scope="col"
                                                        class="px-6 py-3 text-sm font-medium text-white uppercase text-start">
                                                        No
                                                    </th>
                                                    <th scope="col"
                                                        class="px-6 py-3 text-sm font-medium text-white uppercase text-start">
                                                ...
                                                @foreach ($members as $member)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 text-base font-medium text-white">
                                                            {{ $member['major'] }}</td>
                                                        <td
                                                            class="flex items-center gap-4 px-6 py-4 text-base font-medium text-white">
                                                            <button type="button"
                                                                @role(['admin']) wire:click="status({{ $member['id'] }},'hadir')" @endrole
                                                                class="flex gap-1 rounded-md items-center text-base font-medium border {{ $member['status'] == 'hadir' ? 'text-white bg-[#34C759] border-[#34C759]' : 'border-[#4F4F55]' }} @role(['admin']) hover:text-white hover:bg-[#34C759] hover:border-[#34C759] @endrole px-2 md:px-4 py-1.5">
                                                                Hadir
                                                            </button>
                                                            <button type="button"
                                                                @role(['admin']) wire:click="status({{ $member['id'] }},'izin')" @endrole
                                                                class="flex gap-1 rounded-md items-center text-base font-medium border {{ $member['status'] == 'izin' ? 'text-white bg-[#007AFF] border-[#007AFF]' : 'border-[#4F4F55]' }} @role(['admin']) hover:text-white hover:bg-[#007AFF] hover:border-[#007AFF] @endrole px-2 md:px-4 py-1">
                                                                Izin
                                                            </button>
                                                            <button type="button"
                                                                @role(['admin']) wire:click="status({{ $member['id'] }},'alpha')" @endrole
                                                                class="flex gap-1 rounded-md items-center text-base font-medium border {{ $member['status'] == 'alpha' ? 'text-white bg-[#FF3B30] border-[#FF3B30]' : 'border-[#4F4F55]' }}  @role(['admin']) hover:text-white hover:bg-[#FF3B30] hover:border-[#FF3B30] @endrole px-2 md:px-4 py-1.5">
                                                                Alpha
                                                            </button>
                                                        </td>
                                                    </tr>
