    ...
    <section class="">
                            ...
                            <div class="flex-wrap justify-between w-full lg:flex">
                                ...
                                <div class="items-end inline mt-3 md:flex md:justify-between">
                                    <div class="flex gap-6 mt-4 text-gray-400">
                                        ...
                                        <a href="{{ route('app.e-learning.modul.edit') }}"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center w-full p-6 mb-4 bg-glass rounded-xl">
                ...
                <div class="flex-wrap justify-between w-full lg:flex">
                    <div class="">
                        <h1 class="mb-1 font-semibold text-white text-md md:text-xl"><a href="">Fundamental HTML
                                dan CSS
                                Dasar</a>
                        </h1>
                        <span class="text-sm font-light text-gray-400 md:font-medium md:text-base">Mengenal Fundamental
                            HTML dan
                            CSS
                            Dasar untuk
                            Pemula</span>
