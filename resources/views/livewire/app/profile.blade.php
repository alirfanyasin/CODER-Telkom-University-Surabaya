<div>
    ...
    <section class="flex flex-col gap-6 mb-6 md:flex-row">
        <div class="p-6 text-center rounded-lg md:w-4/12 bg-glasses h-fit">
            ...
            <h2 class="mb-3 text-xl font-semibold text-white">Irfan Yasin</h2>
            <p class="mb-3 text-xs font-light text-white">- Web Development -</p>
            <p class="mb-3 text-xs font-light text-white">ID-2024-RND-4782</p>
