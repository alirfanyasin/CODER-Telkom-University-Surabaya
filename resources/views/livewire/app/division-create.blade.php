      ...
      <div class="w-full mb-5 lg:w-2/3 md:mb-0">
        <div class="text-white border-transparent bg-glass rounded-xl p-7">
          <div class="division-title mb-7">
            ...
            <div>
                <input wire:model='name' class="block w-full px-4 py-3 text-sm bg-transparent border-2 border-gray-600 rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" type="text" placeholder="Name division">
