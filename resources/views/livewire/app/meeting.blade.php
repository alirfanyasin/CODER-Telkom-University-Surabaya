<div>
  ...
  <header class="flex items-center justify-between mb-5">
    <h2 class="text-3xl font-bold text-white">Daftar Petemuan</h2>
    <a href="" class="flex items-center px-5 py-3 text-sm font-semibold text-black bg-white rounded-md">Buat
  ...
  <section>
    <a href="/app/e-learning/meetings/pertemuan-1" class="block">
