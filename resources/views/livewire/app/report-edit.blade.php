<div>
  <header class="flex items-center justify-between my-7">
    <h2 class="text-2xl font-bold text-white md:text-3xl">Edit Laporan</h2>
  </header>
        ...
        <div class="grid grid-cols-1 gap-4 mb-3 lg:grid-cols-2">
          <div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="datetime-local" name="date-time" id="date-time" value="2024-08-31T19:30"
            ...
            <label for="file-input"
              ...
              <span class="text-xs" id="file-name">HTML Dasar.pdf</span>
            </label>
            @error('file')
      ...
      <div class="flex my-7">
        <div class="ml-auto flex items-center gap-4">
          ...
          <button type="submit"
            ...
            Edit Laporan <iconify-icon icon="mingcute:arrow-right-line" class="text-xl ms-2"></iconify-icon>
          </button>
        </div>
      </div>
    </form>
