<div>
  <header class="flex my-7">
    <h2 class="text-2xl font-bold text-white md:text-3xl">Artikel Baru</h2>
  </header>
  ...
  <form wire:submit='store' enctype="multipart/form-data">
    <div class="w-full p-6 mb-6 bg-glass rounded-xl">
      <div class="justify-between block mb-6 md:flex gap-9">
        <div class="w-full mb-6 md:mb-0">
          ...
          <input type="text" id="input-label" class="block w-full p-3 text-white rounded-lg bg-lightGray"
            placeholder="Judul artikel" wire:model='name'>
          @error('name')
      ...
      <div class="w-full">
        ...
        @include('livewire.components.utilities.text-editor')
        @error('description')
          <small class="text-red-600"> {{ $message }} </small>
        @enderror
      </div>
