        ...
        <div class="flex h-screen flex-row justify-center items-center z-10">
            <div class="flex flex-col bg-glass text-center shadow-sm rounded-2xl">
                <div class="p-4 md:p-10">
                    ...
                    <button type="button"
                        class="w-full py-3 px-4 mb-2 inline-flex justify-center items-center gap-x-2 text-sm rounded-lg border border-transparent bg-white bg-opacity-30 disabled:opacity-50 disabled:pointer-events-none">
