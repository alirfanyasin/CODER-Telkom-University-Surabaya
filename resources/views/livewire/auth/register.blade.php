<div>
  <div class="container relative">
    <div class="z-10 flex flex-row items-center justify-center h-screen">
      <div class="flex flex-col text-center shadow-sm bg-glass rounded-2xl">
        <div class="p-4 md:p-10">
          ...
          <p class="text-xs text-white">Apakah Anda sudah mempunyai akun? <a href="{{ route('login') }}" wire:navigate
              class="font-semibold">Masuk</a>
          </p>
        </div>
      </div>
    </div>
