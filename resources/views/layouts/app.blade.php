        ...
        <div class="hidden sm:block">
          ...
          <div class="relative min-w-72 md:min-w-80">
            <div class="absolute inset-y-0 z-20 flex items-center pointer-events-none start-0 ps-4">
              <iconify-icon icon="lucide:search" class="flex-shrink-0 text-gray-400 size-4"></iconify-icon>
            </div>
            <input type="text" id="icon" name="icon"
              class="block w-full px-4 py-2 text-sm text-white border-gray-200 rounded-lg ps-11 bg-lightGray focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
              placeholder="Search">
          </div>
        </div>
